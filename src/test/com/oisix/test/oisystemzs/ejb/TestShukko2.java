...
/**
 * 後続の在庫があるものを出庫。割り込み出庫。
 *
 * @author Yamashita
 */
public class TestShukko2 extends ServletTestCase
{
     ...
     */
    public TestShukko2(String theName)
    {
        super(theName);
    }
    ...
    public static Test suite()
    {
        ...
        return new TestSuite(TestShukko2.class);
    }
