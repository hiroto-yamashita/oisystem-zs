...
import com.oisix.oisystemzs.objectmap.HacchuustatusMap;
...
public class HacchuustatusselectTag extends TagSupport {
    ...
    public int doStartTag() throws JspTagException {
        ...
        TreeMap formatMap =
          HacchuustatusMap.getHacchuustatusMap();
        Iterator iter = null;
        ...
        try {
            ...
            throw new JspTagException(
              "error printing hacchuustatusselect tag");
        }
