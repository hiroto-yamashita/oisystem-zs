...
import com.oisix.oisystemzs.objectmap.HanbaikubunMap;
...
public class HanbaikubunselectTag extends TagSupport {
    ...
    public int doStartTag() throws JspTagException {
        ...
        TreeMap formatMap =
          HanbaikubunMap.getHanbaikubunMap();
        Iterator iter = null;
        ...
        try {
            ...
            throw new JspTagException(
              "error printing hanbaikubunselect tag");
        }
