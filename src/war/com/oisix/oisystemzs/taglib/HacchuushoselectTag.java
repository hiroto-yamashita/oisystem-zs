...
import com.oisix.oisystemzs.objectmap.HacchuushoFormatMap;
...
public class HacchuushoselectTag extends TagSupport {
    ...
    public int doStartTag() throws JspTagException {
        ...
        TreeMap formatMap =
          HacchuushoFormatMap.getHacchuushoFormatMap();
        Iterator iter = null;
        ...
        try {
            ...
            throw new JspTagException("error printing hacchuushoselect tag");
        }
